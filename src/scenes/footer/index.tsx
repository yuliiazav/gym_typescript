...
const Footer = () => {
    return (
        <footer className="bg-primary-100  md:py-14 xs:py-10 pt-10 pb-20">
            <div className="justify-content mx-auto w-5/6 gap-16 md:flex">
                <div className="mt-10 md:pt-0  xs:mt-10 basis-1/2 md:mt-0">
                ...
                <div className="mt-10 basis-1/4 xs:mt-5 md:mt-0">
                ...
                <div className="mt-10 basis-1/4  xs:my-8 md:mt-0 ">
